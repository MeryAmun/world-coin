...
import { black, formula, gif, group_12, image5, vector } from '../../assets'
    ...
    <div className='home'>
        ...
        <div className="home__hero-section-left">
          <div className="home__hero-section-left-content">
            <h3 className="home__hero-section-title">
              Cost Effective Distributed AI Training on Ethereum
            </h3>
            {/* Cost Effective Distributed AI Training on Ethereum */}
      ...
      <div className="home__section-two">
        ...
        <div className="home__section-three">
          <div className="home__section-five-global">
            <div className="section__five-left-global">
              <h3 className="section__five-left-title-global">
                "Worldcoin: <br /> Transforming Global Transactions"
              </h3>
              <div className="five__left-paragraph-global">
            ...
            <div className="section__five-global-right">
              <h5 className="section__five-right-header">
                Inputs
              </h5>
              <div className="section__five-global-right-image">
      ...
      <div className="home__section-five">
        ...
        <div className="section__five-left">
          <h3 className="section__five-left-title">
            "Revolutionizing the <br /> Internet Economy"
          </h3>
